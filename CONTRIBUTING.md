...
Please do not report security vulnerabilities on the public GitHub issue tracker. The [Responsible Disclosure Program](https://github.com/auth0-lab/fga-dotnet-sdk/blob/main/.github/SECURITY.md) details the procedure for disclosing security issues.
